...
function TtyOutput(buffer, writer, target, opts) {
	this.ansi = new AnsiOutput(buffer, opts);
	if(target.stdout)
		target = target.stdout;
	target.write("\x1b[3J\x1b[H\x1b[?25l");
	TtyOutput.super_.call(this, buffer, writer, target, opts);
...
TtyOutput.prototype.resize = function(x, y) {
	// TODO
};
