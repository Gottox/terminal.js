...
Terminal.prototype = {
  ...
  diff: function(otherTerm) {
    ...
    // TODO need to do this as the last patch (to make sure all lines have been created)
    // Change of Cursor
