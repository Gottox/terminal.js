...
var TermBuffer = require('./term_buffer.js');
...
/**
* Terminal is the glue between a TerminalBuffer and the escape sequence
* interpreters.
* @constructor
*/
function Terminal(options) {
	...
	this.buffer = new TermBuffer(this.options.columns, this.options.rows, this.attributes);
	this.oldChunk = null;
...
* @params element a DOM element node
* @params options options field
* @returns a terminal input which can be used to send data to a pty
*/
Terminal.prototype.dom = function(element, opts) {
	var input = new DomInput(element, this.buffer, opts);
	var output = new DomOutput(this.buffer, this, element, opts);
