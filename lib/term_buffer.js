...
* @param {string} [attr.fg=null] initial foreground color
* @param {string} [attr.bg=null] initial background color
* @param {boolean} [attr.bold=false] terminal is bold by default
* @param {boolean} [attr.underline=false] terminal is underlined by default
* @param {boolean} [attr.italic=false] terminal is italic by default
* @param {boolean} [attr.blink=false] terminal blinks by default
* @param {boolean} [attr.inverse=false] terminal has reverse colors by default
* @constructor
*/
function TermBuffer(columns, rows, attr) {
...
* @private
*/
TermBuffer.prototype._pipe = function(src) {
...
*/
TermBuffer.prototype.resize = function(size) {
	var line;
...
*/
TermBuffer.prototype.ledOn = function(led) {
...
* disables all LEDs
*/
TermBuffer.prototype.resetLeds = function() {
	this._leds = [!!0,!!0,!!0,!!0];
	this.emit('ledchange', Array.apply(null, this._leds));
	return this;
};
...
* rows
*/
TermBuffer.prototype.getBufferRowCount = function() {
