...
TermDiff.prototype._validateDiff = function(diff) {
	...
	if (diff.savedcursor) { this._savedCursor = diff.savecursor.splice(0); }
...
TermDiff.prototype._applyTabs = function(diff) {
	if (diff.tabs) {
		//TODO
	}
};

TermDiff.prototype._applySavedCursor = function(diff) {
	if (diff.savedcursor) {
		//TODO
	}
};

TermDiff.prototype._applyModes = function(diff) {
	if (diff.modes) {
		//TODO
	}
};

TermDiff.prototype._applyChanges = function(diff) {
	if (diff.changes) {
		//TODO
	}
};
