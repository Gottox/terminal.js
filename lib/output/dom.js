...
function setHtml(view, innerHtml) {
...
DomOutput.prototype.changeLine = function(number, view, line, cursor) {
	...
	view = setHtml(view, this.html._renderLine(line, cursor));
...
DomOutput.prototype.updateHeight = function() {
	...
	this.spacer = setHtml(this.spacer, html);
	this.spacer.style.lineHeight = diff === 0 ? '0' : 'inherit';
};
